...
const makeNoiseHandler = ({ keyPair: { private: privateKey, public: publicKey }, NOISE_HEADER, mobile, logger, }) => {
    // Check if logger is defined and if it has the child method
    if (logger && typeof logger.child === 'function') {
        logger = logger.child({ class: 'ns' });
    } else {
        // Fallback if logger is not defined or child method is missing
        logger = {
            trace: console.log,
            child: () => logger,
        };
        console.warn("Logger is undefined or doesn't support child(). Using fallback logger.");
    }
