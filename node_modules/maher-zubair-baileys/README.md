# ***Multi-Device Whatsapp Baileys Developed By [`Maher-Zubair`](https://github.com/Maher-Zubair)***
...
``` ts 
import makeWASocket from 'maher-zubair-baileys'
```
...
``` ts
import makeWASocket, { DisconnectReason } from 'maher-zubair-baileys'
...
``` ts
import makeWASocket, { BufferJSON, useMultiFileAuthState } from 'maher-zubair-baileys'
...
``` ts
import makeWASocket, { makeInMemoryStore } from 'maher-zubair-baileys'
...
``` ts
import { MessageType, MessageOptions, Mimetype } from 'maher-zubair-baileys'
...
const templateButtons = [
    {index: 1, urlButton: {displayText: '⭐ Star Baileys on GitHub!', url: 'https://github.com/Maher-Zubair/SIGMA-MD'}},
...
``` ts
// send a link
const sentMsg  = await sock.sendMessage(id, { text: 'Hi, this was sent using https://github.com/Maher-Zubair/SIGMA-MD' })
```
...
import { downloadMediaMessage } from 'maher-zubair-baileys'
...
1. Functionality to track the battery percentage of your phone.
   ...
   - read more about this format [here](/src/WABinary/readme.md)
    ...
    ```
# ***This Repository Is Owned By [`Maher-Zubair`](https://github.com/Maher-Zubair) Usage And CopyRights Are Reserved***